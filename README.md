...
- запустить файл `Palantir.exe` или (для просмотра оповещений) открыть терминал в текущей папке и запустить файл `Palantir.exe`
...
- по окончании работы нажать в окне терминала комбинацию клавиш `Ctrl`+`C`
